...
/* 0116
	if (opt != 0) {
    	webiopi().callMacro("setStatus", 0);
	}
*/
// 0119 alert("exitconfopt=" + opt + " y=" + testy);
    $('#opt').val(opt);
...
// 0119	testx++;
// 0119	alert("callbackexitconf-" + testx);
...
//function getStatus() { webiopi().callMacro("getStatus", 2, callbackGetStatus); } //hello
function getStatus() { webiopi().callMacro("getStatus", [], callbackGetStatus); }
